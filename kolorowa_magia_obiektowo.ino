...
Led red(RED, 20);      //Utworzono obiekt klasy Led port RED, duration 20
Led green(GREEN, 15);  //Utworzono obiekt klasy Led port GREEN, duration 15
Led blue(BLUE, 10);    //Utworzono obiekt klasy Led port BLUE, duration 10
